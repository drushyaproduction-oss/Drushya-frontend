...
const BannerContact = () => {
  ...
  const fetchBanners = async () => {
    setIsLoading(true);
    try {
      const { data } = await fetchBannersApi('Contact');
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans flex">
      ...
      <div className="flex-1 lg:ml-72 flex flex-col min-w-0 transition-all duration-300">
        <Header title="Contact Banner Management" toggleSidebar={() => setIsSidebarOpen(true)} />

        <div className="p-6">
          <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-800">Contact Banners</h2>
            <button 
